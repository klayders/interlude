...
public class GameServerConfiguration {
  ...
  public static GameServerConfiguration _instance;
  private final SelectorThread<GameClient>[] _selectorThreads;
  private Version version;
  private TelnetServer statusServer;
  private final GameServerConfiguration.GameServerListenerList _listeners;
...
//  }
  ...
  public GameServerConfiguration() throws Exception {
    _instance = this;
    this._serverStartTimeMillis = System.currentTimeMillis();
    this._listeners = new GameServerConfiguration.GameServerListenerList();
//    (new File("./log/")).mkdir();
...
//    log.info("Compiler version: ........ " + this.version.getBuildJdk());
  ...
  public GameServerConfiguration.GameServerListenerList getListeners() {
